...
VALUES(105, '데이비드','김','DAVIDKIM','23/04/19','IT_PROG');
SELECT * FROM emps_it;
ROLLBACK;
...
기존의 데이터는 email, phone, salary,comm_pct, man_id, dept_id를
업데이트 하도록 처리
새로 유입된 데이터는 그대로 추가.
*/
...
UPDATE depts
    SET manager_id = 301
    WHERE department_name = '회계부' OR department_name = '재정' OR department_name = '인사' OR department_name = '영업';
...
INSERT INTO jobs_it
    VALUES('IT DEV','아이티개발팀',6000,20000);
